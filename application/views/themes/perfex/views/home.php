    ...
    <div class="col-md-12 section-client-dashboard">
        ...
        <?php if (has_contact_permission('invoices')) { ?>
            <div class="tw-mb-3">
                ...
                <?php if (has_contact_permission('invoices')) { ?>
                    <a href="<?= site_url('clients/statement'); ?>" class="tw-text-sm">
            ...
            <div class="panel_s">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-xs-3 col-md-3 col-sm-3 col-lg-3 tw-mb-2 sm:tw-mb-0">
                                <?php if (count($payments_years) > 0) { ?>
                                    <div class="form-group top_stats_wrapper">
                                        <select data-none-selected-text="<?= _l('dropdown_non_selected_tex'); ?>"
                                            ...
                                            <?php foreach ($payments_years as $year) { ?>
                                                <option value="<?= e($year['year']); ?>" <?php if ($year['year'] == date('Y')) {
                                                      echo 'selected';
                                                  } ?>>
                                                    <?= e($year['year']); ?>
                                                </option>
                                    ...
                                    <div id="currency" class="form-group mtop15" data-toggle="tooltip"
                                        ...
                                        <select data-none-selected-text="<?= _l('dropdown_non_selected_tex'); ?>"
                                            ...
                                            <?php foreach ($currencies as $currency) {
                                                ...
                                                <option value="<?= e($currency['id']); ?>" <?= e($selected); ?>>
                                                    <?= e($currency['symbol']); ?>
                                                    -
                                                    <?= e($currency['name']); ?>
                                                </option>
