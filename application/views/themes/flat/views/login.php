<?php defined('BASEPATH') or exit('No direct script access allowed'); ?>
		<div class="col-lg-6 no-padding" style="padding-left:0px; padding-right:0px; background:#fff;height: 100vh;-webkit-box-shadow: 0 2px 30px 2px rgba(0,0,0,.1) !important; box-shadow: 0px 2px 30px 2px rgba(0,0,0,.1) !important;" >
            ...
            <div style="width: 100%; height: 50px;">
				...
				<?php } else { ?>
				<div class="form-title1" style="float: left;"><img style="float: right;" src="/uploads/company/cbb7dea1b43ac5f6912c33527786eac4.png" class="img-responsive" alt="logotype"></div><div class="form-title2" style="float: right; margin-top: 20px; margin-bottom: 30px; color:#d0d0d0;"><?php echo _l('clients_login_heading_no_register'); ?></div>
                <?php } ?>
			</div>	
