...
*
*/
define('APP_BASE_URL', 'https://kundenportal.sellx.studio/');
...
*/
define('APP_ENC_KEY', 'e4a5d26595e8d5d5d4281284eba9761c');

/**
 * Database Credentials
 * The hostname of your database server
 */
define('APP_DB_HOSTNAME', '185.240.242.29');

/**
 * The username used to connect to the database
 */
define('APP_DB_USERNAME', 'trixi-kp-db');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'dBDg3NY9TIsjiNVAuDxH');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'kpdb');
