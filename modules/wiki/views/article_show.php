...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo site_url('assets/plugins/tinymce/plugins/codesample/css/prism.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/builds/tailwind.css?v=3.2.1'); ?>">
...
<body>
    ...
    <div id="mySidebar" class="sidebar" style="width: 250px;">
        ...
        <div class="button-header">
            <a class="btn btn-primary pull-left display-block" href="<?php echo admin_url('wiki/articles'); ?>">
                <?php echo _l('home'); ?>
            </a>
        </div>
        <div class="button-header">
            <a class="btn btn-primary pull-left display-block" href="<?php echo admin_url('wiki/books'); ?>">
    ...
    <script
        src=" <?php echo base_url(WIKI_ASSETS_PATH . '/articles_show/javascripts/jquery/jquery-1.8.3.min.js'); ?>"></script>
    <script
        src=" <?php echo base_url(WIKI_ASSETS_PATH . '/articles_show/javascripts/jqueryui/jquery-ui-1.9.1.custom.min.js'); ?>"></script>
