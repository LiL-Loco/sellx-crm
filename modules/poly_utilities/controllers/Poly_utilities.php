...
class Poly_utilities extends AdminController
{
    ...
    {
        hooks()->do_action('before_poly_utilities_reset_custom_menu', true);// For PolyDemo, handle or integrated hook features in the next version.
    ...
    {
        hooks()->do_action('before_poly_utilities_delete_custom_menu', true);// For PolyDemo, handle or integrated hook features in the next version.
