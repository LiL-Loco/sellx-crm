                    ...
                    <div class="col-md-12">
                        ...
                        <?php if (appointlyGoogleAuth()) { ?>
                            <?php if ($history['google_event_id'] !== null && $history['google_added_by_id'] == get_staff_user_id()) { ?>
                                <input type="text" hidden value="<?= $history['google_event_id']; ?>"
                        ...
                        <div class="form-group select-placeholder">
                            ...
                            <select <?= isset($history['details']) || $history['source'] == 'lead_related' ? 'disabled' : ''; ?>
                                    name="rel_type" id="rel_type" class="selectpicker" data-width="100%"
                                    data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                <?php if (isset($history['details'])) : ?>
                                    <option value=""></option>
                                <?php endif; ?>
                                <option <?= (isset($history['details']) && $history['source'] == 'external') ? 'selected' : ''; ?>
                                        id="external"><?= _l('appointments_source_external_label'); ?>
                                </option>
                        ...
                        <div class="form-group" id="div_name">
                            ...
                            <input type="text" <?= isset($history['details']) || $history['source'] == 'lead_related' ? 'disabled' : ''; ?>
                                   value="<?= $history['name'] ?? $history['details']['full_name']; ?>"
                                   class="form-control" name="name" id="name">
                        </div>
                        <div class="form-group" id="div_email">
                            <label for="email"><?= _l('appointment_email'); ?></label>
                            <input type="email" <?= isset($history['details']) || $history['source'] == 'lead_related' ? 'disabled' : ''; ?>
                                   value="<?= $history['email'] ?? $history['details']['email']; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                   value="<?= $history['address'] ?? ''; ?>" name="address"
                                   id="address">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-group appointment_type_holder">
                                ...
                                <select class="form-control selectpicker" name="type_id" id="appointment_select_type">
                                    ...
                                    <?php foreach ($appointment_types as $app_type) { ?>
                                        <option <?= ($app_type['id'] == $history['type_id']) ? 'selected' : ''; ?>
                                                class="form-control" data-color="<?= $app_type['color']; ?>"
                                                value="<?= $app_type['id']; ?>"><?= $app_type['type']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                                <small id="appointment_color_type" class="pull-right appointment_color_type"
                                       style="background: <?= ($app_color) ? $app_color : '#e1e6ec'; ?>"></small>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="checkbox">
                                        <input type="checkbox" name="by_sms"
                                               id="by_sms" <?= $history['by_sms'] == 1 ? 'checked' : '' ?>>
                                        <label for="by_sms"><?= _l('appointment_sms_notification_text'); ?></label>
                                    </div>
                                    <div class="checkbox">
                                        <input type="checkbox" name="by_email"
                                               id="by_email" <?= $history['by_email'] == 1 ? 'checked' : '' ?>>
                    ...
                    if (
                        ...
                        <button type="button" 
                                ...
                                class="btn btn-primary"><?= _l('appointment_add_to_calendar'); ?>&nbsp;<i
                                    class="fa-brands fa-google" aria-hidden="true"></i>
                        </button>
                    <?php } ?>
                    <?php
                } ?>
                ...
                if (
                    ...
                    <button type="button" id="addToOutlookBtn"
                            ...
                            class="btn btn-primary"><?= _l('appointment_add_to_outlook'); ?>&nbsp;<i
                                class="fa-regular fa-envelope" aria-hidden="true"></i>
                    </button>
                <?php } ?>
