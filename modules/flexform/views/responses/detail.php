...
<div class="flexform-detail-wrapper">
    <p class="text-center tw-mb-2 tw-text-lg tw-font-semibold"><?php echo $response[$i]['date_added']; ?> (<?php echo time_ago($response[$i]['date_added']); ?>)</p>
    <p class="text-right">
    ...
    <div class="flexform-answers" id="flexformSubmissionAnswers">
        <?php foreach ($all_blocks as $block) : ?>
            ...
            <div class="flexform-detail-block">
                <h5 class="flexform-title-preview tw-mb-2"><i class="fa <?php echo $block['static']['icon'] ?> tw-text-primary tw-mr-2"></i> <?php echo $block['title']; ?></h5>
