							...
							<div class="horizontal-scrollable-tabs preview-tabs-top">
								...
								<div class="tab-content">
									...
									<div role="tabpanel" class="tab-pane" id="tab_notes">
										...
										<div class="text-right">
											<button type="submit" class="btn btn-success mtop15 mbot15"><?php echo _l('contract_add_note'); ?></button>
										</div>
										<?php echo form_close(); ?>
										<hr />
									...
									<div role="tabpanel" class="tab-pane" id="tab_comments">
										<div class="row contract-comments mtop15">
											<div class="col-md-12">
												...
												<button type="button" class="btn btn-success mtop10 pull-right" onclick="add_contract_comment();"><?php echo _l('proposal_add_comment'); ?></button>
											</div>
										</div>
									</div>
								...
								<div role="tabpanel" class="tab-pane" id="tab_templates">
									<div class="row contract-templates">
										<div class="col-md-12">
											<button type="button" class="btn btn-success" onclick="add_template('contracts', <?php echo new_html_entity_decode($contract_addendum->id) ?>);"><?php echo _l('add_template'); ?></button>
											<hr>
										</div>
										<div class="col-md-12">
