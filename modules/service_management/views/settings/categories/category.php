...
<div> 
	...
	<?php if(has_permission('service_management', '', 'create')){ ?>
		<a href="#" onclick="new_category(); return false;" class="btn btn-success pull-left display-block">
			<?php echo _l('sm_add'); ?>
		</a>
	<?php } ?>
	<br>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<?php if (has_permission('service_management', '', 'create') || has_permission('service_management', '', 'edit') || is_admin()) { ?> 
						<button type="submit" class="btn btn-success intext-btn"><?php echo _l('submit'); ?></button>
					<?php } ?>
				</div>
			</div>
			<?php echo form_close(); ?>
